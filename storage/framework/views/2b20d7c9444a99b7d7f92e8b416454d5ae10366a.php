...
<?php $__env->startSection('contentheader_title', 'Danh sách Tỉnh '); ?>


<?php $__env->startSection('main-content'); ?>
    

<div class="row" ng-controller="ProvinceController">
    <div class="col-lg-12">
			...
			<div class="modal-content">
			  ...
			  <div class="modal-body">
				<form name="frm" class="form-horizontal"><?php echo e(csrf_field()); ?>
					...
					<div class="form-group">
						<label for="inputEmail3" class="col-sm-3 control-label">Mã </label>
						<div class="col-sm-9">
							<input type="text" class="form-control" id="province_code" name="province_code" placeholder="Vui lòng nhập mã" ng-model="item.province_code"  ng-required="true" />
							<span id="helpBlock2" class="help-block" ng-show="frm.province_code.$error.required" >Vui lòng nhập mã</span>
						</div>
					</div>
					<div class="form-group">
...
<script src="<?php echo asset('public/app/controllers/provincecontroller.js'); ?>"></script>
<?php $__env->stopSection(); ?>
