...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="<?php echo e(url('sinhvien')); ?>"><i class='fa fa-link'></i> <span>Sinh viên</span></a></li>
            <li class="treeview">
                <a href="#"><i class='fa fa-link'></i> <span>HỆ THỐNG</span> <i class="fa fa-angle-left pull-right"></i></a>
                <ul class="treeview-menu">
                    <li><a href="<?php echo e(url('area')); ?>">Vùng</a></li>
                    <li><a href="<?php echo e(url('province')); ?>">Thành phố</a></li>
                    <li><a href="<?php echo e(url('distrist')); ?>">Huyện</a></li>
                </ul>
            </li>
            <li class="treeview">
                <a href="#"><i class='fa fa-link'></i> <span>KHÁCH HÀNG</span> <i class="fa fa-angle-left pull-right"></i></a>
                <ul class="treeview-menu">
